...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  //   [1, 2, 3, 4] la posicion del ultEL = 3
  //     0 , 1, 2, 3
  //     array[3]
  //   [1,2,3,4].length = 4  =>
  var ultimoElemento = array[array.length - 1]; // var ulEl = array[4-1]
...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  //   Hello // undefined Hello Wold!
  var palabraUnida; // "Hello world!"
